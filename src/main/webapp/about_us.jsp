...
<head>
    ...
    <title>SwiftShip - About Us</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1 py-5">
        <div class="container">
            ...
            <div class="text-center mb-5">
                <h1 class="text-brand fw-bold">About SwiftShip</h1>
                <p class="text-muted fs-5">Simplifying logistics for Malaysian SMEs and e-commerce sellers.</p>
            </div>

            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="bg-light rounded-4 d-flex align-items-center justify-content-center border shadow-sm" style="height: 350px;">
                        <div class="text-center text-muted">
                            <i class="bi bi-image" style="font-size: 4rem;"></i>
                            <p class="mt-2 fw-medium"></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 ps-lg-5">
                    ...
                    <p class="text-muted lh-lg">
                        Whether you are sending a parcel to Kuala Lumpur or across the sea to Sabah and Sarawak, we want to make the process as smooth as possible. We bring together trusted carriers like DHL, Pos Laju, and J&T Express so you can focus on growing your business while we handle the logistics tracking.
                    </p>
                </div>
            </div>
            ...
            <div class="row align-items-center flex-column-reverse flex-lg-row">
                <div class="col-lg-6 pe-lg-5 mt-4 mt-lg-0">
                    ...
                    <ul class="list-unstyled text-muted mt-3">
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-brand me-2"></i> Compare shipping rates instantly across top carriers.</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-brand me-2"></i> Track all your parcels in one centralized dashboard.</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-brand me-2"></i> Generate detailed reports to analyze your shipping costs.</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <div class="bg-light rounded-4 d-flex align-items-center justify-content-center border shadow-sm" style="height: 350px;">
    ...
    <div class="chatbot-window" id="chatWindow">
        ...
        <div class="chatbot-messages" id="chatMessages">
            <div class="message bot-message">Hello! I'm your SwiftShip logistics assistant. Do you have any questions about our team or services?</div>
        </div>
        <div class="chatbot-input-area">
            <input type="text" id="chatInput" placeholder="Ask a question..." onkeypress="handleChatEnter(event)">
    ...
    <script>
        ...
        function sendChatMessage() {
            ...
            setTimeout(() => {
                ...
                botMsgDiv.innerText = "I'm a prototype right now, but soon I'll be able to answer questions about SwiftShip using the Gemini API!";
